            ...
            <ul class="nav">
                ...
                <li>
                    ...
                    <div id="employees" class="collapse ">
                        <ul class="nav">
                            <li><a href="page-profile.html" class="">Create List</a></li>
                            <li><a href="page-profile.html" class="">Employee List</a></li>
                ...
                <li>
                    ...
                    <div id="vendor" class="collapse ">
                        <ul class="nav">
                            <li><a href="page-profile.html" class="">Vendor Registration</a></li>
                            <li><a href="page-profile.html" class="">Vendor wise Product List</a></li>
                ...
                <li>
                    ...
                    <div id="products" class="collapse ">
                        <ul class="nav">
                            <li><a href="page-profile.html" class="">Add Product</a></li>
                            <li><a href="page-profile.html" class="">Add Product Category</a></li>
                            <li><a href="page-login.html" class="">Update Product</a></li>
                            <li><a href="page-lockscreen.html" class="">Delete Product</a></li>
                            <li><a href="page-lockscreen.html" class="">Live Stock</a></li>
                            <li><a href="page-lockscreen.html" class="">Product List</a></li>
